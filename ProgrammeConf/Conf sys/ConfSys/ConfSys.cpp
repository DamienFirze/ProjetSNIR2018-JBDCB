...
// ConfSys.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CConfSys, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CConfSys
...
// Seul et unique objet CConfSys

CConfSys theApp;


// initialisation de CConfSys

BOOL CConfSys::InitInstance()
{
